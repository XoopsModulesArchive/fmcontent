...
$xoopsTpl->assign('breadcrumb_show', xoops_getModuleOption('bc_show', $forMods->getVar('dirname')));
$xoopsTpl->assign('breadcrumb_modname', xoops_getModuleOption('bc_modname', $forMods->getVar('dirname')));
$xoopsTpl->assign('breadcrumb_tohome', xoops_getModuleOption('bc_tohome', $forMods->getVar('dirname')));
