...
class ModuleAdmin {
	...
	function renderMenuIndex() {
		...
		if ($this->_obj->getInfo ( 'help' )) {
			$ret .= "<a href=\"" . $pathsystem . "help.php?mid=" . $this->_obj->getVar ( 'mid', 's' ) . "&amp;" . $this->_obj->getInfo ( 'help' ) . "\" title=\"" . _AM_SYSTEM_HELP . "\">" . "<img src=\"" . $path . "images/admin/help.png\" alt=\"" . _AM_SYSTEM_HELP . "\" /> ";
